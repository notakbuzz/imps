...
function track_private() {
   ...
   git clone --depth=1 "git@github.com:FreakyOS/WallBucket.git" packages/apps/WallBucket
   git clone --depth=1 "git@github.com:FreakyOS/packages_apps_Graveyard.git" -b test2 packages/apps/Graveyard
